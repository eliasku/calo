import {_enum, array, bool, CString, f32, i32, type, u32, u8} from "./common.js";
...
export const sg_text_layer = type("sg_text_layer", {
    color: Color,
    offset: Vec2,
    blur_radius: f32,
    blur_iterations: u32,
...
export const sg_keyframe_transform = type("sg_keyframe_transform", {
    position: Vec2,
    scale: Vec2,
    skew: Vec2,
    pivot: Vec2,
...
const sg_frame_label = type("sg_frame_label", {
    frame: i32,
    name: CString,
});

const sg_frame_script = type("sg_frame_script", {
    frame: i32,
    code: CString,
});

export const sg_scene_info = type("sg_scene_info", {
...
export const sg_dynamic_text = type("sg_dynamic_text", {
    text: CString,
    font: StringHash32,
    size: f32,
    alignment: Vec2,
...
export const sg_easing = type("sg_easing", {
    ease: f32,
    curve: array(Vec2),
    attribute: u8,
});
...
// }
// #endif
export const sg_movie_frame = type("sg_movie_frame", {
    index: i32,
    duration: i32,
    motion_type: i32,
...
export const sg_node_data_struct = type("sg_node_data_struct", {}, {
    apiStreamRead: true,
    apiStreamWrite: true,
    extern: true,
    target: {
...
export const sg_movie_layer = type("sg_movie_layer", {
...
export const sg_node_data = type("sg_node_data", {
    ...
    hit_area_enabled: bool,
    bounds_enabled: bool,
    bounding_rect: RectF,
    scale_grid: RectF,
    children: sg_node_data_array,
    dynamic_text: array(sg_dynamic_text),
    movie: array(sg_movie),
